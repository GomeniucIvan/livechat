...
class EmojiIcon extends Component {
  ...
  render() {
    return (
      <div className="app-customer-input-picker-wrapper">
      { this.state.isActive && 
        <EmojiPicker 
      ...
      <button
        ...
        className="app-customer-input-emoji-icon-wrapper"
      >
        <svg
          className={`app-customer-input-emoji-icon ${(this.props.isActive ? 'active' : '')}`}
          version="1.1"
          id="Layer_2"
