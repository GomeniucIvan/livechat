...
namespace Smartstore.Core.Common
{
    ...
    public class GenericAttributeCollection
    {
        ...
        {
            Map.Clear();
            foreach (var attr in Entities.OrderByDescending(x => x.Id))
            {
        ...
        public bool TryGetEntity(string key, out GenericAttribute entity)
        {
