namespace Smartstore.Core.Configuration
{
    ...
    public partial interface ISettingService
    {
        ...
        T GetSettingByKey<T>(string key, T defaultValue = default, bool doFallback = false);
        ...
        /// <param name="doFallback">A value indicating whether a shared (for all stores) value should be loaded if a value specific for a certain store is not found</param>
        /// <returns>Setting value</returns>
        Task<T> GetSettingByKeyAsync<T>(string key, T defaultValue = default, bool doFallback = false);
        ...
        Task<Setting> GetSettingEntityByKeyAsync(string key);
        ...
        Task<ApplySettingResult> ApplySettingAsync<T>(string key, T value);
