...
namespace Smartstore
{
    public static class ISettingServiceExtensions
    {
            ...
            where T : ISettings, new()
        {
            ...
            return await service.SettingExistsAsync(key);
        }
            ...
            where T : ISettings, new()
        {
            ...
            return await service.ApplySettingAsync(key, currentValue);
        }
            ...
            where T : ISettings, new()
        {
            ...
            return await service.RemoveSettingAsync(key);
        }
        ...
        {
            return await service.ApplySettingAsync(settings, keySelector);;
        }
    }
}